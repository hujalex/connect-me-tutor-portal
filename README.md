...
## Overview
The Connect Me Tutor Portal provides an internal tool to meet our organization's need to serve a growing user base, allowing our leadership team to manage tutoring sessions in a scalable and sustainable manner while providing tutors and students with additional quality-of-life features.
...
## Administrators
- **Sessions Schedule** - Full schedule of all Connect Me tutoring sessions
- **Tutors Dashboard** - User interface to navigate through Connect Me's tutors
- **Students Dashboard** - User interface to navigate through Connect Me's students
- **Volunteer Hours Dashboard** - User interface to view volunteering hours for each user, by each week, month, and all time

## In Development
- Worksheets in Resources List
- Chat System for Tutors and Students to communicate through direct messages
- Automated Pairing System - provides suggested pairings for tutors
